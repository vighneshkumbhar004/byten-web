...
import { heroData, companyInfo } from "../mock/mockData";
      ...
      <Dialog open={demoDialogOpen} onOpenChange={setDemoDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your email and we will schedule an intelligence briefing with our team — or call us directly.
            </DialogDescription>
          </DialogHeader>
          ...
          <a
            ...
            className="flex items-center gap-3 w-full bg-[#0A111A] hover:bg-[#1a2233] text-white font-semibold py-3 px-5 rounded-xl transition-all duration-300 group mt-2"
          >
            <div className="bg-[#FFCC00] rounded-full p-2 group-hover:scale-110 transition-transform duration-300">
              <Phone size={18} className="text-[#0A111A]" />
            </div>
            <div>
              <p className="text-xs text-gray-400 font-normal">Call us directly</p>
              <p className="text-lg tracking-wide">+91 {companyInfo.phone}</p>
            </div>
          </a>

          <div className="flex items-center gap-3 my-1">
            <div className="flex-1 h-px bg-gray-200" />
            <span className="text-xs text-gray-400 font-sans">or submit your email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
