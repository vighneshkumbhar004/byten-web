// Mock data for Byten Geomapping Technologies Landing Page
...
export const footerSections = [
  {
    title: "Solutions",
    links: [
      { name: "Drone Mapping & Surveying", href: "#" },
      { name: "Infrastructure Monitoring", href: "#" },
      { name: "Industrial Inspections", href: "#" },
      { name: "Digital Twin Platform", href: "#" },
  ...
  },
  {
    title: "Industries",
    links: [
      { name: "Infrastructure & Civil", href: "#" },
      { name: "Energy & Power Grid", href: "#" },
      { name: "Mining & Quarrying", href: "#" },
