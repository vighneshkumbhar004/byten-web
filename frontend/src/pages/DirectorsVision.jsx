      ...
      <section className="py-20 relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32 relative">
          ...
          >
            <div className="rounded-2xl overflow-hidden border border-white/20 shadow-2xl relative aspect-[4/5] max-w-md mx-auto lg:max-w-none lg:mx-0 bg-gray-900 group">
              ...
              <img 
                ...
                alt="Er. Ashish Shantisagar Biradar" 
          ...
          <motion.div 
            ...
            className="space-y-6 text-lg text-gray-300 font-sans leading-relaxed bg-white/5 backdrop-blur-xl p-10 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden"
          >
          ...
          {[
            ...
            return (
              <motion.div 
                ...
                className="bg-black/40 backdrop-blur-xl rounded-3xl p-10 border border-white/10 hover:border-[#FFCC00]/50 transition-all duration-500 group relative overflow-hidden"
              >
            ...
            <div className="flex flex-col gap-4 group">
              <div className="flex items-center justify-between bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-xl transition-all duration-300 group-hover:border-[#FFCC00]/30">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     <h3 className="text-lg font-bold text-white font-heading">Certificate of Recognition</h3>
                     <p className="text-xs text-gray-400 font-sans">Official Operational Clearance</p>
                   </div>
                 </div>
                 <a href="/assets/certifiate_of_recogniation.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-[#FFCC00]/10 hover:bg-[#FFCC00] text-[#FFCC00] hover:text-gray-900 rounded-lg text-sm font-bold transition-colors border border-[#FFCC00]/20">
              ...
              <div className="w-full aspect-[1/1.3] bg-gray-900 rounded-2xl border border-white/10 overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.5)] relative group-hover:border-[#FFCC00]/30 transition-colors duration-300">
                <iframe 
                  src="/assets/certifiate_of_recogniation.pdf#toolbar=0&navpanes=0&scrollbar=0" 
            ...
            <div className="flex flex-col gap-4 group">
              <div className="flex items-center justify-between bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-xl transition-all duration-300 group-hover:border-[#FFCC00]/30">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     <h3 className="text-lg font-bold text-white font-heading">Government Letter</h3>
              ...
              <div className="w-full aspect-[1/1.3] bg-gray-900 rounded-2xl border border-white/10 overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.5)] relative group-hover:border-[#FFCC00]/30 transition-colors duration-300">
                <iframe 
                  src="/assets/government_letter.pdf#toolbar=0&navpanes=0&scrollbar=0" 
